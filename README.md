...
- [PlexRipper](https://www.plexripper.rocks/) - A cross-platform Plex media downloader that seamlessly adds media from other Plex servers to your own! ([Source Code](https://github.com/PlexRipper/PlexRipper)) `GPL-3.0` `C#/Docker`
